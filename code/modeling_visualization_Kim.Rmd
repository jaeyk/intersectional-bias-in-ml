...
hateful_out <- glm(hateful ~ black + gender + party_ID + black*gender + black*party_ID, family = binomial(link = "logit"), data = df)

abusive_slim <- glm(abusive ~ black + gender + black*gender, family = binomial(link = "logit"), data = df)
  
abusive_out <- glm(abusive ~ black + gender + party_ID + black*gender + black*party_ID, family = binomial(link = "logit"), data = df)
